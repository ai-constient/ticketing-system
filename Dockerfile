...
ENV OSTICKET_VERSION=${OSTICKET_VERSION:-"v1.18"} \
    ...
    OSTICKET_REPO_URL=${OSTICKET_REPO_URL:-"https://github.com/ai-constient/ticketing-system"} \
...
### Download & Prepare OSTicket for Install
    clone_git_repo "${OSTICKET_REPO_URL}" "main" /assets/install && \
