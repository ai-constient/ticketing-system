...
class API {
    ...
    function getTempIPAddr() {
        $ipaddr = $this->ht['ipaddr'];
    ...
    static function getIdByKeyLike($key, $ip='') {
    ...
    // Remove Ip Address validation
    static function lookupByKeyLike($key) {
        return self::lookup(self::getIdByKeyLike($key));
    }
...
class ApiController extends Controller {
    ...
    protected function getTempRemoteAddr() {
    ...
    function getKey() {
        ...
        if (!$this->key
            ...
            // Remove Ip Address validation
            if(!$this->key){
                $this->key = API::lookupByKeyLike($key);
            }
        return $this->key;
    }
